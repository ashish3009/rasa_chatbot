...
class ActionSendMail(Action):
	...
	def run(self,dispatcher,tracker,domain):
		...
		subject=tracker.get_slot("cuisine").title() + " Restaurant recommendations in "+tracker.get_slot("location").title() + " by RasaBot"
		
        # Open the plain text file whose name is in textfile for reading.
		with open(r'body.txt') as fp:
		...
		msg['Subject'] = subject
		msg['From'] = 'RasaBot restaurant search'
		msg['To'] = to
